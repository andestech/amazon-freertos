...
#include "wifi/wilc1000/wireless_driver_extension/wilc1000_task.h"
#include "wifi/wilc1000/wireless_driver_extension/driver/include/m2m_wifi.h"
...
extern void wilc1000_init_completed();
extern void wilc1000_connect_event_received(bool connected, bool isServer, uint8_t *client);
extern void wilc1000_eth_data_received(uint32_t len, uint8_t *frame);
extern void wilc1000_scan_completed(uint32_t status);
extern void wilc1000_wps_completed(void);
extern void wilc1000_rf_ready(uint8_t *mac);
		...
		if (pstrWifiState->u8CurrState == M2M_WIFI_CONNECTED) {
			if (g_wilc1000_intf->ethMode) {
				if (s_isSoftAP) {
					...
					WDRV_DBG_INFORM_MESSAGE(("Wi-Fi Connected softAP\r\n"));
				} else {
